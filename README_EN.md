...
This installs 16 Bohrium skills (English versions).
...
| [bohrium-database](en/bohrium-database/SKILL.md) | Custom database — inspect schemas, query/filter/export rows, insert/update/delete records, create and alter tables |
